...
const PL_CORE: Spec[] = [
  ...
  { code: "A-20", category: "warning", shape: "warning-triangle", glyph: "cross", en: "Two-way traffic", pl: "Odcinek jezdni dwukierunkowej", ru: "Двустороннее движение", meaningEn: "Two-way traffic begins.", meaningPl: "Początek ruchu dwukierunkowego.", meaningRu: "Начинается двустороннее движение." },
